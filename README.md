...
Invoke a library API function from the command-line:
    ...
    $ clojure -X prestancedesign.inertia-clojure/foo :a 1 :b '"two"'
...
Your library will be deployed to com.github.prestancedesign/inertia-clojure on clojars.org by default.
